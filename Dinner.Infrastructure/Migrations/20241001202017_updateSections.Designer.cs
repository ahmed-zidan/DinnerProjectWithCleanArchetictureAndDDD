...
namespace Dinner.Infrastructure.Migrations
{
    ...
    [Migration("20241001202017_updateSections")]
            ...
            modelBuilder.Entity("Dinner.Domain.MenuAggregate.Menu", b =>
                {
                    ...
                    b.OwnsMany("Dinner.Domain.Dinner.ValueObjects.DinnerId", "MenuDinnerId", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("Dinner.Domain.MenuAggregate.Entities.MenuSection", "MenuSections", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier")
